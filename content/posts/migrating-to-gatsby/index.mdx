...
I planned to use Gatsby for a long time now, but deferred up until now.

There was no real strong reason to migrate from Jekyll to [Gatsby](https://www.gatsbyjs.org/).
I have been wanting to try out Gatsby for sometime now, and migrating something that was 
live would have given a good hands on. So I decided to try out Gatsby on this blog. I would not 
say that it was a breeze, especially because I wanted to preserve the existing URLs of my blog. 
I tried out the steps given at this 
[Gatsby post](https://www.gatsbyjs.org/blog/2017-11-08-migrate-from-jekyll-to-gatsby/) 
but it did not work for me. Following is the notes on what I did different.
