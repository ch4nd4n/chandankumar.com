...
> in this process. Implementing things in Remix has been breeze
> so far.
...
Above lines of code initializes Firebase and GoogleAuthProvider.
`signInWithPopup` method takes care of opening up the Google Sign
in window.

Final component would look something like below.
...
but over all I love it. I am going to build a working application using
Remix and keep posting follow ups.

You may like the following

1. [Remix Run Tutorial: Mongodb connection with Mongoose](http://localhost:8000/blog/remix-run-mongodb-tutorial)
